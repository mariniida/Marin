    ...
    <div class="section flexContainer tileContainer alignEnd">
      ...
      <div class="flexItem description">
				<div class="section">
					...
					<p>新しい環境で勉学に励むも、英語力以外のスキルを得たいと強く感じた。「国や言語の垣根を超えたスキルとはなんだろう。」と考えた結果、デザイン職に興味を持ち、メルボルン大学のデザイン学部に進学。</p>
					<p>大学ではデジタルテクノロジーを専攻しHCIについて学びながら、グラフィックデザインとコンピューティングを副専攻。UI/UX、ゲームデザイン、ブランディング、ウェブサイト制作など、幅広い種類の課題に取り組んだ。</p>
				</div>
